...
import timeseriestoraster as ts
...
os.chdir("D:\\UU\processed_files\\temp_maps\\20230323tmin\\") # directory to save maps
ts.temperature_tiff(figdir, fn, dempath, start_date, end_date, csv_out)

#%% Maximum temp

figdir = ("C:/SPHY3/analysis/model_output/fig/dataplot/") # directory to save figure
os.chdir("D:\\UU\processed_files\\temp_maps\\20230323tmax\\") # directory to save maps
fn ='C:\\SPHY3\\analysis\\data_processed\\LSaws_Ta_filledwithERA_20132021max.csv' # time series
dempath = 'D:\\UU\\SPHY\\scratch\\v2\\dem_filled.tif' # dem location
start_date = '2017-01-01'
end_date = '2018-01-01'
csv_out = 'C:\\SPHY3\\analysis\\data_processed\\temp_max_output.csv'
...
#%% Mean temp
figdir = ("C:/SPHY3/analysis/model_output/fig/dataplot/") # directory to save figure
os.chdir("D:\\UU\processed_files\\temp_maps\\20230323temp\\") # directory to save maps
fn ='C:\\SPHY3\\analysis\\data_processed\\LSaws_Ta_filledwithERA_20132021.csv' # time series
dempath = 'D:\\UU\\SPHY\\scratch\\v2\\dem_filled.tif' # dem location
start_date = '2017-01-01'
end_date = '2018-01-01'
csv_out = 'C:\\SPHY3\\analysis\\data_processed\\temp_mean_output.csv'
