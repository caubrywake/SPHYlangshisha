...
GlacTable       = glac_table_upstream_catchments.csv
...
DDFS            = 4
# SNOW SUBLIMATION PARAMETERS (sublimation rate in mm/day and maximum elevation of sublimation zone in m asl)
# Sublimation rate in middle zone is calculated as linear function in model script
Subl1Rate		= 0
Subl1Hmax		= 3000
Subl2Hmax		= 8000
Subl3Rate		= 7.5
...
Prec            = ../../../../Forcing/HIAWARE/pcr_forcing/WFDEI/upstream5km/prec_leap/prec
# TAIR (map series (define without *.map extension) with air temperature (degrees Celsius))
Tair            = ../../../../Forcing/HIAWARE/pcr_forcing/WFDEI/upstream5km/tavg_leap/tavg
# TLAPSE (lapse rate to lapse model grid cel temperature to glacier elevation temperature (degrees Celsius/m elevation increase)
TLapse          = -0.0065
...
# Only define if ETREF_FLAG = 0. Otherwise can be left empty.
Tmin            = ../../../../Forcing/HIAWARE/pcr_forcing/WFDEI/upstream5km/tmin_leap/tmin
# TMAX (map series (define without *.map extension) with maximum air temperature (degrees Celsius).
# Only define if ETREF_FLAG = 0. Otherwise can be left empty.
Tmax            = ../../../../Forcing/HIAWARE/pcr_forcing/WFDEI/upstream5km/tmax_leap/tmax
...
# SUBLIMATION
TotSUAct_mapoutput		= M
TotSUAct_TSoutput		= NONE
TotSUAct_fname		= Subl
...
GlacID_flag = 1
#-Glacier fluxes to report per glacier ID (list: ['Prec_GLAC', 'Rain_GLAC', 'Snow_GLAC', 'ActSnowMelt_GLAC', 'SnowStore_GLAC', 'SnowWatStore_GLAC',  'TotalSnowStore_GLAC', 'SnowR_GLAC', 'GlacMelt', 'GlacR', 'GlacPerc'])
GlacID_report = Prec_GLAC,SnowR_GLAC,GlacMelt,GlacR,GlacPerc
#-Flag to aggregate to monthly values (1=Yes, 0=No) 
GlacID_month = 1
