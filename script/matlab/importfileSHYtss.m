function T = importfileSPHYtss(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   SMELFMTS = IMPORTFILE(FILENAME)
%   Reads data from text file FILENAME for the default selection.
%
%   SMELFMTS = IMPORTFILE(FILENAME, STARTROW, ENDROW)
%   Reads data from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   SMelFMTS = importfile('SMelFMTS.tss', 15, 3666);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2022/11/01 13:24:33
